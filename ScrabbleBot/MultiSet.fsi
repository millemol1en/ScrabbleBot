(*
    From grown ups: All modules must be internal. 

    Point: The .fsi files work like an interface, meaning that the signature
    and types are specified in the .fsi whereas the functions themselves
    are created in the .fs
*)
...
module internal MultiSet
    ...
    val contains : a : 'a -> MultiSet<'a> -> bool when 'a: comparison
